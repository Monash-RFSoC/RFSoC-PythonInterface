...
class RFSOC4x2(Board):
    ...
    def get_ttl_pins(self):
        ttl_pins = PinDict({
            ...
            "microblaster": [
                ControlPin("MB_FLAG0", 12, ControlPin.INPUT),
                ControlPin("MB_FLAG1", 13, ControlPin.INPUT),
                ControlPin("MB_FLAG2", 14, ControlPin.INPUT),
                ControlPin("MB_FLAG3", 15, ControlPin.INPUT),
                ControlPin("MB_FLAG4", 16, ControlPin.INPUT),
                ControlPin("MB_FLAG5", 17, ControlPin.INPUT),
                ControlPin("MB_FLAG6", 18, ControlPin.INPUT),
                ControlPin("MB_FLAG7", 19, ControlPin.INPUT),
                ControlPin("MB_FLAG8", 20, ControlPin.INPUT),
                ControlPin("MB_FLAG9", 21, ControlPin.INPUT),
                ControlPin("MB_FLAG10", 22, ControlPin.INPUT),
                ControlPin("MB_FLAG11", 23, ControlPin.INPUT),

                ControlPin("MB_RUN", 8, ControlPin.OUTPUT),
                ControlPin("MB_TRIG", 9, ControlPin.OUTPUT),
                ControlPin("MB_RSTN", 10, ControlPin.OUTPUT),
                ControlPin("MB_ISR", 1, ControlPin.OUTPUT),
            ],
            "logger": [
